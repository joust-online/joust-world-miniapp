...
export default function Background() {
  return (
    <div className="fixed inset-0 -z-10 min-h-screen w-full overflow-hidden">
      ...
      {/* Castle silhouette with built-in ground section */}
      <div className="absolute right-0 bottom-0 left-0 h-[60vh] overflow-hidden lg:h-[80vh]">
        <Image
          src={castle as string}
          alt="Castle silhouette"
          fill
          sizes="100vw"
          priority
          className="pointer-events-none object-cover object-right-bottom select-none"
        />
      </div>
